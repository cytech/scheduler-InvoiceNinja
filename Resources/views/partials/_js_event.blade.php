@section('javascript')
    {{--{!! HTML::style('modules/scheduler/css/jquery-ui-peppergrinder.min.css') !!}--}}
    {!! HTML::style('modules/scheduler/css/jquery-ui-cupertino.min.css') !!}
    <style>
    ...
    {!! HTML::script('modules/scheduler/jquery-validation/dist/jquery.validate.min.js') !!}
