...
<div class="form-group">
    {!! Form::model($rrule) !!}
    <div class="form-group">
        {!! Form::label('frequency',trans('Scheduler::texts.frequency_string'),['class'=>'col-sm-2 control-label ']) !!}
        <div class="col-sm-6 ">
            {!! Form::text('frequency',null,['class'=>'form-control ','placeholder'=>'Frequency','readonly']) !!}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('freqtext',trans('Scheduler::texts.frequency_text'),['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-6">
                ...
                success: function (data) {
                    if (data.type === 'success') {
                        ...
                        var notice = new PNotify({
                            ...
                            text: 'Frequency to text is  ' + data.result ,//'Showed the proposed Frequency',
                            //type: 'info',
                            delay: 10000,
                            buttons: {
                                closer: false,
