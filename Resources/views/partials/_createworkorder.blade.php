{!! HTML::style('modules/scheduler/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css') !!}
{!! HTML::script('modules/scheduler/bootstrap-switch/dist/js/bootstrap-switch.min.js') !!}
    ...
    <div class="row">
        <div class="col-md-6 text-center">
            ...
            <table style="margin-left:auto;margin-right:auto" id="wtable">
                ...
                {{--script to get selected worker checkboxes,format as uri, and open new InvoiceNinja workorder--}}
                <script>
                    wstr = '';
